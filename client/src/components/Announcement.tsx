  ...
  const announcements = [
    {
      ...
      date: '2025',
      content: 'bFJHWUDFHIU UIWR FWRFHUIRFHVIRUH HGFRHGVIURHFGVUIRG UWRHFGUIRWGHUIRGHUIRGHUIGH WRFGBUIRG',
    },
    {
      id: 2,
      title: 'OMG Announcement',
      date: '2025',
      content: 'HUIEGHEUIHNILGVUHNNFV IJWRHGIU3RHUIRGHUIJN IUWRIUHNWUIRHRIUG WIURHNIWJNWJF U9WRHU RRU',
    },
    {
      id: 3,
      title: 'XYZ Announcement',
      date: '2025',
      content: 'GBHARHRYJHN JHIE;OTJHIOETGJIROE GOEJRIGJE TGEORTYHOEIJH OIETHGO EKJEHKETHETH T4HRTH Y JRYH4',
    }
  ];

  function sendAnnouncementend() {
    //do it later
  }
  ...
  return (
      ...
      className="flex flex-row overflow-y-auto h-[56rem] w-full px-4 py-16 bg-[#F2F4F8] text-[#545E79] hide-scrollbar">
        ...
        <div className="space-y-6 w-full mr-[8rem]">
          ...
          <div className={`flex flex-row justify-start items-start rounded-lg shadow-md h-[4rem] bg-white hover:bg-[#F2F4F8] ${canAnnouncement ? "h-[22rem]" : "cursor-pointer"}`}
          onClick={doAnnouncement}>

          {!canAnnouncement && <p className='ml-4 mt-4 font-normal opacity-80 '> Do announcement </p>}

          {canAnnouncement && <div className='flex flex-col justify-start items-start w-full h-[22rem] mb-2'>
